...
exports.RACES = [
    ...
    new race_1.Race('Goliath', size_1.Size.Medium, new attribute_dictionary_1.AttributeDictionary(2, -2, 2, -2, 0, 0), '30 ft', '', 'Common, '),
    ...
    new race_1.Race('Tiefling', size_1.Size.Medium, new attribute_dictionary_1.AttributeDictionary(-1, -1, -1, 1, 0, 2), '30 ft', 'darkvision (60 ft)', 'Common, '),
];
