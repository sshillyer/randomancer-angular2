...
export const VILLAIN_WEAKNESSES: VillainWeakness[] = [
    ...
    new VillainWeakness("The villain is destroyed if it speaks it s true name."),
    new VillainWeakness("An ancient prophecy or riddle reveals how the villain can be overthrown."),
    new VillainWeakness("The villain falls when an ancient enemy forgives its past actions."),
    new VillainWeakness("The villain loses its power if a mystic bargain it struck long ago is completed.")
];